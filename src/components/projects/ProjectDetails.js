        ...
        <header className="">
          ...
          >
            ...
            >
              ...
              <h1 className="right">
              <p style={{ color: "blue ", marginTop: "150px", fontSize: "15px" }}>
              ...
              <p style={{ color: "blue ", marginTop: "100px", fontSize: "30px" }}>
              คำแนะนำจากแพทย์
              </p>
                ...
                {project.result <= 50 ? (
                  ...
                  >
                    {" "}
                    <p> อยู่ในเกณฑ์มาตรฐาน ดูแลสุขภาพได้ดีหากหลักเลี่ยงในการเป็นควรวรดูแลตัว
เอง</p>
                   โดยการดื่มน้ำสะอาดให้เพียงพอ ลดอาหารประเภทอาหารที่มีโซเดียมสูง ช็อคโกแลต  ผักปวยเล้ง  มันเทศ  ผลิตภัณฑ์ถั่วเหลือง
                ...
                <p>มีความเสี่ยงค่อนข้างมาก ควรไปโรงพยาบาลเพื่อพบผู้เชี่ยวชาญและดูแลตัว
เอง</p>โดยการดื่มน้ำสะอาดให้เพียงพอ งดอาหารประเภทอาหารที่มีโซเดียมสูง ช็อคโกแลต  ผักปวยเล้ง  มันเทศ  ผลิตภัณฑ์ถั่วเหลือง
                  </p>
                ) : (
                  <p
                    className="my-2"
                  ...
                  <p>มีความเสี่ยงต่ำ ควรดูแลตัว
เองโดยการดื่มน้ำสะอาดให้เพียงพอ </p>ลดอาหารประเภทอาหารที่มีโซเดียมสูง ช็อคโกแลต  ผักปวยเล้ง  มันเทศ  ถั่ว ผลิตภัณฑ์ถั่วเหลือง
                  </p>
                )}
                </div>
              </h1>
